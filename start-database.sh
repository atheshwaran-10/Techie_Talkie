...
DB_CONTAINER_NAME="techie_talkie-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=techie_talkie -d -p 5432:5432 docker.io/postgres
